...
<form action="back.php" method="post" class="form-group">
<?php
$number = 1;
$select = "SELECT * FROM ".$department."";
$result = mysqli_query($connection,$select);
while ($row = mysqli_fetch_assoc($result)) {
echo  $number . "]  ".$row['doctorname']." " . "<input type='password' name='id' style='display:none;' value='".$row['id']."'>
<input type='password' name='department' style='display:none;' value='".$department."'>
